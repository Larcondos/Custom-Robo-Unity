...
public class PlayerController2 : MonoBehaviour {
	...
	*/
	...
	public IEnumerator fireGun() {
		...
		v.GetComponent<BulletPath> ().setTarget2 (enemy, this.gameObject);
		...
		v2.GetComponent<BulletPath> ().setTarget2 (enemy, this.gameObject);
		audioPlayer.clip = gunFireSound;
		audioPlayer.Play ();
		...
		v3.GetComponent<BulletPath> ().setTarget2 (enemy, this.gameObject);
		audioPlayer.clip = gunFireSound;
		audioPlayer.Play ();
